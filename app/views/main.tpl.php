...
<body class="body-connect">
    <header>
        ...
        <div id="volet">
            ...
            <a href="#volet_clos" class="fermer text-light bg-dark font-weight-bold">Close Here</a>
        </div>
    </header>
    <main>
 <!-- Ici on mettrait un tableau des 3 ou 5 meilleurs scores depuis x temps -->
    </main>

<?php include __DIR__ . '/app/views/footer.tpl.php'; ?>
